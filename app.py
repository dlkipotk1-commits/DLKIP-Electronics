...
.side-videos {{ display:grid; grid-template-columns:minmax(110px,.48fr) minmax(0,2fr) minmax(110px,.48fr); gap:14px; margin-bottom:14px; align-items:stretch; }}
.side-video {{
...
.side-video video {{
    display:block; width:100%; aspect-ratio:9 / 16; height:100%; object-fit:cover; background:#050505;
}}
.center-videos {{ display:grid; grid-template-columns:1fr 1fr; gap:14px; min-width:0; }}
.center-video {{
    overflow:hidden; border:1px solid rgba(255,77,0,.32); border-radius:18px; background:#090909;
    box-shadow:0 0 24px rgba(255,55,0,.06); min-width:0;
}}
...
@media(max-width:700px) {{
    ...
    .side-videos {{ grid-template-columns:1fr; }}
...
<section class="side-videos">
    <div class="side-video left">
