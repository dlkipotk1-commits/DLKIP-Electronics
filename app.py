...
.side-videos {{ display:grid; grid-template-columns:1fr 1fr; gap:14px; margin-bottom:14px; }}
.side-video {{
...
.side-video video {{
    display:block; width:100%; aspect-ratio:9 / 16; height:auto; object-fit:cover; background:#050505;
}}
